        ...
        switch ($action) {
            ...
            case 'out':
                ...
                if ($this->encrypted) {
                    ...
                    $creation = $this->ARC4($creation);
                    $modified = $this->ARC4($modified);
                }
...
EOT;
     ...
     * @param array $relatedTo array where the key is the object ID and the value is a string naming the relationship type
     */
    public function addEmbeddedFile(string $filepath, string $embeddedFilename, string $description, string $mimeType = "application/octet-stream", $relatedTo = []): void
    {
        ...
        if (isset($relatedTo) && count($relatedTo) > 0) {
